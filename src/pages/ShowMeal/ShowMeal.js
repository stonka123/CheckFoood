      ...
      >
        ...
        <div className={styles.infoBox}>
          <div>
            ...
            <p className={meal.difficulty == "Hard" ? styles.red : null}>
              {" "}
              {meal.difficulty}{" "}
            </p>
          </div>
        ...
        <div className={styles.containerPrepatation}>
          <h5> Przygotowanie : </h5>
          <p>
            Wszystkie składniki na sos dokładnie mieszamy ze sobą. Kaszę
            gotujemy zgodnie z zaleceniami producenta na opakowaniu. Paprykę,
            kapary i suszone pomidory kroimy w drobną kostkę. Kukurydzę
            odsączamy z zalewy za pomocą sitka. Kolendrę siekamy. Wszystkie
            składniki mieszamy ze sobą, dodajemy nasz sos. Sałatkę układamy za
